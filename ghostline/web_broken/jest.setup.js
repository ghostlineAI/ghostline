...
// Mock environment variables for tests (only set default if caller didn't provide one)
process.env.NEXT_PUBLIC_API_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000/api/v1'
