...
- **Voice Similarity**: **sentence-transformers**.
  - *Rationale*: A proven library for generating high-quality sentence and text embeddings. This will be the foundation of our quantitative voice similarity metric (KPI: ≥ 0.88).
